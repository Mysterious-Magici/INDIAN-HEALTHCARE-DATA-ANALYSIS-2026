...
CREATE TABLE `treatments` (
  ...
  `Treatment_Outcome` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`Treatment_ID`),
  KEY `fk_treatments_visit` (`Visit_ID`),
